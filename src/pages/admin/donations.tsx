...
import { useAdminDonationsColumns } from "@/components/donations/admin-donations-columns";
import DonationsViewDialog from "@/components/donations/donations-view-dialog";
import Main from "@/components/layout/main";
import { useAdminDonations } from "@/hooks/admin/use-admin-donations";

export default function ManageDonationsPage() {
  const donationColumns = useAdminDonationsColumns();
